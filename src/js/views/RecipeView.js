...
import {Fraction} from 'fractional';// For external packages no need to use path
...
// private function to format the decimal
const formatCount = count =>{
    // Using the fractional package
    /*
    if(count){
        // count = 2.5 --> 2 1/2 
        // count = 0.5 --> 1/2
